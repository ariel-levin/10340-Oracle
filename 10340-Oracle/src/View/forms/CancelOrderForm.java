 ...
 *
 */
public class CancelOrderForm extends JFrame {
	...
	public CancelOrderForm(MainFrame mainFrame) {
	...
	private void initFrame() {
		...
		btnCommit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int reply = JOptionPane.showConfirmDialog(null, "Are you sure you wish "
						+ "to delete this order?", "Confirmation", JOptionPane.YES_NO_OPTION);
				
				if (reply == JOptionPane.YES_OPTION) {

					boolean success = mainFrame.getDB().deleteOrder( (Order)cb_orders.getSelectedItem() );
					
					if (success) {
						String msg = "The Order was deleted successfully";
