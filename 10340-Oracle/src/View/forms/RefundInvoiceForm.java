 ...
 *
 */
public class RefundInvoiceForm extends JFrame {
	...
	public RefundInvoiceForm(MainFrame mainFrame) {
	...
	private void initFrame() {
		...
		btnCommit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				mainFrame.refundInvoice( (Invoice)cb_invoice.getSelectedItem() );
				dispose();
			}
		});
	}
